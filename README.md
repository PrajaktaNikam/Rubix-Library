# Rubix-Library ![](spring.PNG)
## Introduction 
A Rubix-Library designed to see the books available in a college library. It allows students to register as a user and issue/return books from the college library hassle free. The backend is designed as a **Monolithic Architecture** with various nuances as discussed below.
...
CLI-->
```
git clone https://github.com/PrajaktaNikam/Rubix-Library.git
cd Rubix-Library
mvn package 
java -jar target/Rubix-Library-0.0.1-SNAPSHOT.jar
```
Intellij/Eclipse-->
